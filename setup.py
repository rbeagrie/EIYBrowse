...
setup(
    ...
    entry_points = {'EIYBrowse.tracks': [
                        ...
                        'square_interactions = EIYBrowse.tracks.interactions:SquareInteractionsTrack',
                        'triangular_interactions = EIYBrowse.tracks.interactions:TriangularInteractionsTrack',
